    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <?php
          if(isset($_SESSION['username'])){
            ...
            <li class="nav-item"><a class="nav-link "href="proprietes.php">Propriétées</a></li>
            <li class="nav-item">
      ...
      <div class="d-flex">
        <?php
           ...
           <button type='button'class='btn btn-outline-dark shadow-none me-lg-2 me-3'><a href='logout.php' class='text-decoration-none'>Se déconnecter</a></button>";
           }else{
            ...
            <button type='button' class='btn btn-outline-dark shadow-none me-lg-2 me-3' data-bs-toggle='modal' data-bs-target='#registerModal'>S'inscrire</button>";
           }
        ?>
        </div>
       </div>
