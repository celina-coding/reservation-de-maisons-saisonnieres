...
<?php
  ...
  <div style="width:70%; height:220px; margin-top:50px;" class="container w-70 p-4 rounded mb-3 shadow footer-color">
    <div class="row">
        <div class="col-lg-12 p-4">
          <div class="text-center mb-3">
          <i class="bi bi-exclamation-lg"></i>
          </div>
          <h5 class="text-center">Vous n'avez rien réservé pour le moment </h5>
        </div>
    </div>
  </div>
